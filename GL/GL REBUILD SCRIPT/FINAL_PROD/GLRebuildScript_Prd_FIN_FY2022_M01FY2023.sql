...
-- nohup sqlplus FCC114/password @GLRebuildScript_Prd_FIN_FY2022_M01FY2023.sql > GLRebuildScript_Prd_FIN_FY2022_M01FY2023.log &
...
!date
DECLARE
  LPeriod  sttm_branch.current_period%type  :='M01';
